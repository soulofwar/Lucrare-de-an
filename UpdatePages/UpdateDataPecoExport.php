...
if (mysqli_num_rows($result) > 0) {
 ...
 $sql = "UPDATE pret_vandut SET ID = '$ID_Company', Nume_Companie = '$company', Tip_Combustibil = '$combustibil', Cantitate = '$cantitate', Pret_Vandut = '$pret', Data = '$data' WHERE Data = '$data'";
...
<img src="../Images/logoGas.png" alt="LogoPeco" width="130px" height="100px">
  ...
  <div class="background_Images">
    ...
    <header>
    <div class="header"><h2>Peco Station Export</h2></div>
