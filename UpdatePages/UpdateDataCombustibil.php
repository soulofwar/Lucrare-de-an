...
$sql = "UPDATE combustibil SET ID = '$ID_Company', Tip_Combustibil = '$combustibil', Tara_Import = '$tara', Data_Importare = '$data' WHERE Data_Importare = '$data';
";
 ...
 if($conn->query($sql) === TRUE) {
  ...
  $msg = "<div class='Succes'>Data nu este corecta!</div>"; 
   }
} else {
...
<body>
  ...
  <div class="background_Images">
    ...
    <header>
    <div class="header"><h2>Peco Station Resources DataModify</h2></div>
  ...
  <script src="../HTML/InsertDataCombustibil.js"></script>
</body>
</html>