...
if (mysqli_num_rows($result) > 0) {
 ...
 $sql = "INSERT INTO pret_achizitionata(ID, Nume_Companie, Tip_Combustibil, Cantitate, Pret_Achizitionat, Data)
 VALUES ('$ID_Company', '$company', '$combustibil', '$cantitate', '$pret', '$data')";
